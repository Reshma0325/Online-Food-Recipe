                ...
                <div class="header-search-form-wrapper">
                    <form action="" class="header-search-form for-des">
                        <div class="search-input-wrapper">
                            <input type="date" name="search" class="form-input" style="width:400px; height:50px;">
                            <button type="submit">
                ...
                <div class="sec-wp">
                    ...
                    <div class="container"><br>
                        ...
                        if (isset($_GET['search']) && !empty($_GET['search'])) {
                            $search = $_GET['search'];
                            $recipe_query = "SELECT * FROM tbl_recipes WHERE Placed_On = '$search'";
                            ...
                            if (mysqli_num_rows($recipe_result) == 0) {
                                ...
                                <script>
                                    Swal.fire({
                                        ...
                                        window.location = "day_report.php";
                                    });
                                </script>
                        <?php
                            } else {
