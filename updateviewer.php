...
session_start();
 $res = mysqli_query($con, "SELECT * FROM `tbl_Users` WHERE User_Id=$_SESSION[viewer_id]") or die('query failed');
            ...
            if ($update_result) {
                ...
                <script>
                    swal({
                        ...
                        window.location = "viewerdetails.php";
                    });
                </script>
            <?php
            } else {
                ...
                <script>
                    swal({
                        ...
                        window.location = "updateviewer.php";
                    });
                </script>
            <?php
            }
