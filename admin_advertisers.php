            ...
            <section class="about-sec section">
                        ...
                        <div class="container">
                                <div id="recipes-container">
                                    ...
                                    $recipe_query = "SELECT * FROM tbl_users where  User_Type = 'advertiser' LIMIT $offset, $publishersPerPage";
                                ...
                                <div class="pagination">
                                        <?php
                                        $totalRecipesQuery = "SELECT COUNT(*) as total FROM tbl_users where User_Type='advertiser'";
