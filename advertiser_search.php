    ...
    $recipe_result = mysqli_query($con, $recipe_query); 
        ...
        <script>
            Swal.fire({
                ...
                window.location = "advertiser_search.php";
                });
        </script>
        <?php
    }
                                        ...
                                        <div class="col-lg-4 col-sm-6 dish-box-wp breakfast" data-cat="breakfast">
                                            <div class="dish-box text-center">
                                                ...
                                                <div class="dist-bottom-row">
                                                    <ul>
                                                        <li>     
                                                            <a href="#?addid=<?php echo $recipe['Recipe_Id'];?>" class="header-btn" style="width: 165px;color:#ffffff; background: linear-gradient(145deg, #ffc954, #ffbc00);box-shadow: inset 4px 4px 8px #d6a029, inset -4px -4px 8px #ffd837;">Add Advertisement</a>
                                                        </li>
                                                        <li>
