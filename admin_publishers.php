                        ...
                        <div class="container">
                                <div id="recipes-container">
                                    ...
                                    ?>
                                            ...
                                            <a href="admin_publishers_recipe.php?viewid=<?php echo $recipe['User_Id'];?>" class="header-btn" style="width: 110px;color:#ffffff; background: linear-gradient(145deg, #ffc954, #ffbc00);box-shadow: inset 4px 4px 8px #d6a029, inset -4px -4px 8px #ffd837;">View Recipe</a>
