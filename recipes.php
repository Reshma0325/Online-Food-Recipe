...
.pagination a:hover {
 ...
 function showSubcategories(categoryId) {
    ...
    xmlhttp.open("GET", "adminget_subcategories.php?category_id=" + categoryId, true);
    xmlhttp.send();
}
...
function showRecipesForCategory(categoryId) {
    ...
    xmlhttp.open("GET", "adminget_recipes.php?category_id=" + categoryId, true);
    xmlhttp.send();
}
...
function showRecipesForSubcategory(subcategoryId) {
    ...
    xmlhttp.open("GET", "adminget_recipes.php?subcategory_id=" + subcategoryId, true);
    xmlhttp.send();
}
