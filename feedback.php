    ...
    <div id="viewport" style="overflow-y: auto; max-height: 100vh; ">
        <div id="js-scroll-content">
            <section class="about-sec section">
                        ...
                        $recipe_query = "SELECT * FROM tbl_users JOIN tbl_messages ON tbl_users.User_ID = tbl_messages.User_ID  LIMIT $offset, $publishersPerPage";
                    ...
                    <div class="pagination">
                            <?php
                            $totalRecipesQuery = "SELECT COUNT(*) as total FROM tbl_users where User_Type='viewer'";
