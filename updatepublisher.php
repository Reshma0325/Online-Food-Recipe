            ...
            <center>
                ...
                <div class="flex">
                    ...
                    <input type="hidden" value="<?php echo $row['User_Id']; ?>" name="user_id">
                        ...
                        <div class="inputbox">
                            <i class="uil uil-envelope" style="font-size: 32px; color: black;"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['User_Mail']; ?>
                        </div>
                        <div class="textbox">
...
if (isset($_POST['submit'])) {
    ...
    if ($check_result) {
        if (mysqli_num_rows($check_result) == 1) {
            $query = "UPDATE `tbl_Users` SET `User_Name`='$user_name',`User_Mobile`='$user_mobile',`User_Gender`='$user_gender',`User_Date_Of_Birth`='$user_dob',`User_Password`='$newpassword',`User_Image`='$upload_image' WHERE User_Id = '$user_id'";
            ...
            if ($update_result) {
                ...
                <script>
                    swal({
                        ...
                        window.location = "publisherdetails.php";
                    });
                </script>
            <?php
            } else {
                ...
                <script>
                    swal({
                        ...
                        window.location = "updatepublisher.php";
                    });
                </script>
            <?php
            }
